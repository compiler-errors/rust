...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn iter_local_def_id(self) -> impl Iterator<Item = LocalDefId> + use<'tcx> {
    ...
    pub fn all_traits(self) -> impl Iterator<Item = DefId> + use<'tcx> {
...
impl<'tcx> TyCtxt<'tcx> {
    pub fn debug_stats(self) -> impl std::fmt::Debug + use<'tcx> {
