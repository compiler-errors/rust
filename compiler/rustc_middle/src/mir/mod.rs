...
impl<'tcx> Body<'tcx> {
    ...
    #[inline]
    pub fn mut_vars_iter<'a>(&'a self) -> impl use<'a, 'tcx> Iterator<Item = Local> {
    ...
    pub fn mut_vars_and_args_iter<'a>(
        &'a self,
    ) -> impl use<'a, 'tcx> Iterator<Item = Local> {
    ...
    #[inline]
    pub fn drain_vars_and_temps(&mut self) -> impl use<'_, 'tcx> Iterator<Item = LocalDecl<'tcx>> {
