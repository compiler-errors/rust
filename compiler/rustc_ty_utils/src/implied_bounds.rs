...
fn fn_sig_spans(tcx: TyCtxt<'_>, def_id: LocalDefId) -> impl use<'_> Iterator<Item = Span> {
...
fn impl_spans(tcx: TyCtxt<'_>, def_id: LocalDefId) -> impl use<'_> Iterator<Item = Span> {
