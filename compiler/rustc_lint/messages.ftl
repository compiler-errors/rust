...
lint_unused_visibility = unnecessary visibility on unnamed const
    .label = visibility on an unnamed constant is not necessary since it cannot be imported
    .suggestion = remove the unnecessary visibility keyword
