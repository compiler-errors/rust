...
impl<'tcx, 'a> crate::GenKillAnalysis<'tcx> for MaybeStorageLive<'a> {
    ...
    fn statement_effect(
        ...
        match stmt.kind {
            StatementKind::StorageLive(l) => trans.gen___(l),
...
impl<'tcx, 'a> crate::GenKillAnalysis<'tcx> for MaybeStorageDead<'a> {
    ...
    fn statement_effect(
        ...
        match stmt.kind {
            ...
            StatementKind::StorageDead(l) => trans.gen___(l),
            _ => (),
        }
    }
...
impl<'tcx> crate::GenKillAnalysis<'tcx> for MaybeRequiresStorage<'_, 'tcx> {
    ...
    fn before_terminator_effect(
        ...
        match &terminator.kind {
            TerminatorKind::Call { destination, .. } => {
                trans.gen___(destination.local);
            }
    ...
    fn call_return_effect(
        ...
        return_places.for_each(|place| trans.gen___(place.local));
    }
}
